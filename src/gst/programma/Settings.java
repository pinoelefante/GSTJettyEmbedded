...
public class Settings {
	...
	private static final int	VersioneSoftware		= 12;
	...
	public void setSendNotify(boolean s){
		aggiungiOpzione("notifiche_abilitate", s+"");
	}
	public boolean isSendNotify(){
		String opt = getOpzione("notifiche_abilitate");
	...
	public void setVLCPath(String p){
		aggiungiOpzione("vlc_path", p!=null?p:"");
	}
	public String getVLCPath(){
		String p = getOpzione("vlc_path");
		return p;
	}
