...
public class FrameOpzioni extends JFrame {
	...
	public FrameOpzioni(){
		...
		panel_7.setBounds(10, 57, 453, 114);
		...
		FlowLayout flowLayout_17 = (FlowLayout) panel_4.getLayout();
		flowLayout_17.setAlignment(FlowLayout.LEFT);
		panel_7.add(panel_4);
		
		chckbxNotificheAbilitate = new JCheckBox("Notifiche abilitate");
		panel_4.add(chckbxNotificheAbilitate);
		...
		panel_20.setBounds(10, 172, 453, 55);
		...
		panel_27.setBounds(10, 225, 453, 55);
		...
		panel_28.setBounds(10, 352, 453, 55);
		...
		FlowLayout flowLayout_16 = (FlowLayout) panel_3.getLayout();
		flowLayout_16.setAlignment(FlowLayout.LEFT);
		panel_3.setBorder(new TitledBorder(null, "VLC", TitledBorder.CENTER, TitledBorder.TOP, null, null));
		panel_3.setBounds(10, 279, 453, 51);
		panel_15.add(panel_3);
		
		dirVLC = new JTextField();
		panel_3.add(dirVLC);
		dirVLC.setColumns(30);
		
		btnSfogliaVLC = new JButton("Sfoglia");
		panel_3.add(btnSfogliaVLC);
	...
	private void addListener(){
		...
		btnSfogliaVLC.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String destinazione_path = "";
				if(Os.isWindows()){
					destinazione_path=System.getenv("PROGRAMFILES")+File.separator+"VideoLan";
				}
				else if(Os.isLinux()){
					destinazione_path="/usr/bin";
				}
				...
				chooser.setFileFilter(new ClientFilter("Vlc", filename));
				...
				dirVLC.setText(destinazione_path);
			}
		});
	...
	public void init(){
		...
		chckbxNotificheAbilitate.setSelected(s.isSendNotify());
	...
	private JTextField dirVLC;
	private JButton btnSfogliaVLC;
	private JCheckBox chckbxNotificheAbilitate;
		...
		if(al_salva==null){
			al_salva = new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					s.setSendNotify(notificheAbilitate);
